...
/**
 * Created by parkjeongho on 2023-12-19 오후 12:16
 */
class NC900NSReader extends NfcReader {

    public NC900NSReader(Context context) {
        super(context);

        applicationLabel = "TMOBILEPASS_CARD";
        applicationID = new byte[] {
                (byte)0xF4, (byte)0x10, (byte)0x48, (byte)0x43, (byte)0x67, (byte)0x31, (byte)0x32};
