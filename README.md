# TMobilepass Android SDK
 티모바일패스 안드로이드 SDK는 모바일ID를 NFC/BLE 기능을 통해 사용자가 간단하고 안전하게 ID 인증 서비스를 이용할 수 있도록 한다.
...
### onGetTerminalId(String sTerminalId)
...
### onGetTokenCompleted(boolean result)
